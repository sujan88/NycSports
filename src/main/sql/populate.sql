...
INSERT INTO product VALUES ('P1','2014-11-10','Apple iPhone 5s smartphone with 4.00-inch 640x1136 display and 8-megapixel rear camera',false, 'Apple','IHF Helmat','New',500,1,1000,'Guard')
INSERT INTO product VALUES ('P2','2014-11-10','Google Nexus 7 is the lightest 7 inch tablet With a quad-core Qualcomm Snapdragon',false, 'Google','Hand Gloves','New',800,1,1000,'Guard')
