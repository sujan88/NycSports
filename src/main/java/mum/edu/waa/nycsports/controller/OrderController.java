...
public class OrderController {
	...
	public String checkOut(@RequestParam String cartId, Model model){
	...
	public String orderConfirm(@Valid @ModelAttribute("shippingDetail") ShippingDetail shippingDetail,BindingResult result, Model model){
		if(result.hasErrors())
		{
		return 	"/checkout/collectShippingDetail";
		}
